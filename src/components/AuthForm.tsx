        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col space-y-3 pt-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" type="button" onClick={() => toast.info('Google авторизация будет доступна в следующей версии')}>
                Google
              </Button>
              <Button variant="outline" type="button" onClick={() => toast.info('ВКонтакте авторизация будет доступна в следующей версии')}>
                ВКонтакте
              </Button>
            </div>
          </div>
